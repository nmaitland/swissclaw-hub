...
describe('startHubGateway conversation routing', () => {
  ...
  it('stores inbound message conversation id in OriginatingTo', async () => {
    ...
    await handler?.({
      ...
      conversation_id: '123e4567-e89b-12d3-a456-426614174000:swissclaw.hydeabbey.net',
    });

    expect(finalizeInboundContext).toHaveBeenCalledWith(
      expect.objectContaining({
        OriginatingTo: '123e4567-e89b-12d3-a456-426614174000:swissclaw.hydeabbey.net',
      }),
    );
  });
