...
INSERT INTO users (id, email, name, role) VALUES 
    ...
    ('test-user-2', 'operator@example.com', 'operator', 'user')
...
INSERT INTO kanban_tasks (id, title, description, status, priority, assigned_to, column, tags) VALUES 
    ...
    ('task-3', 'Add TypeScript support', 'Convert client and server to TypeScript', 'backlog', 'medium', 'operator', 'backlog', ARRAY['typescript']),
